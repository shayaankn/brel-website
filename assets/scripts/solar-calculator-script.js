document.addEventListener("DOMContentLoaded", function () {
    ...
    function updateCalculations() {
        ...
        var multiplier = usageType.value === "commercial" ? 1.2 : 1.0;
        ...
        if (!isNaN(billAmount)) {
            ...
            var price = (billAmount * 90 * multiplier).toLocaleString("en-IN", { style: "currency", currency: "INR" });
...
// OLDER SCRIPT - Without Home/Commercial Option
// document.addEventListener("DOMContentLoaded", function () {
//     var billInput = document.getElementById("billInput");
//     var systemSizeDiv = document.getElementById("div-system-size");
//     var systemPriceDiv = document.getElementById("div-system-price");
